                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="text-center text-secondary">Register New Nurse</h4>
                        </div>
                        <div class="card-body">
                        <form action="doc_nurse_regdb.php" method="POST">
                            ...
                            <?php while($row = $result->fetch_assoc()) { ?>
                                <tr>
                                    ...
                                    <td class="btn-group btn-group-justified">                                       
                                         <a href="doc_nurse_regdb.php?delete=<?php echo $row['id']; ?>" class="badge bg-danger mx-1" 
                                         onclick="return confirm('This will be deleted completely?');">Delete</a>
                                        <a href="doc_nurse_reg.php?edit=<?php echo $row['id']; ?>" class="badge bg-success">Edit</a>
                                    </td> 
                                </tr>
                            <?php }?>
                            </tbody>
