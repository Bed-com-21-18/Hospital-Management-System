					...
					while ($row = $result->fetch_assoc()) { ?>
						 <tr>
							...
							<td class='btn-group btn-group-justified'>                                    
									<a href='update_drug.php?view=<?php echo $row["id"]; ?>' class='badge bg-success'>Update</a>
									 &nbsp;<a href='delete_drug.php?delete=<?php echo $row["id"]; ?>' class='badge bg-danger'>Delete</a>
