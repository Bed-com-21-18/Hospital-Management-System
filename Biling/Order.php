...
<?php include('./constant/connect');
 ...
 $sql = "SELECT id, order_date, patient_name, payment_status FROM hospital_orders WHERE delete_status = 0";
       ...
       <div class="page-wrapper">
            ...
            <div class="container-fluid">
                 ...
                 <div class="card">
                            ...
                            <a href="add-order.php"><button class="btn btn-primary">Add bill</button></a>
