        ...
        <div class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <?php }?>
                        <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-file"></i><span class="hide-menu">Biling</span></a>
                            <ul aria-expanded="false" class="collapse">
                           
                                <li><a href="add-order.php">Add Bill</a></li>
                           
                                <li><a href="Order.php">Manage Bills</a></li>
                            </ul>
                        </li>
                         
                        <li> <a class="has-arrow" href="appointments.php" aria-expanded="false"><i class="fa fa-file"></i><span class="hide-menu">Appointments</span></a>

                        <?php if(isset($_SESSION['userId']) && $_SESSION['userId']==1) { ?>
                         <!-- <li><a href="report.php" href="#" aria-expanded="false"><i class="fa fa-print"></i><span class="hide-menu">Reports</span></a></li> -->

                            <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-flag"></i><span class="hide-menu">Records</span></a>
                                <ul aria-expanded="false" class="collapse">
                            
                                    <li><a href="patient_records.php">Patient Records</a></li>
                                    <!-- <li><a href="sales_report.php">Sales Report</a></li> -->
                                    <li><a href="medicine_records.php">Medicine Records</a></li>
