            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-10 mx-auto">
                        ...
                        <?php 
                        $sql = "SELECT brand_id, brand_name, brand_active, brand_status FROM medicine_brands WHERE brand_status = 1 AND brand_active = 1";
                        ...
                        <option value="">~~SELECT~~</option>
                        <?php 
                        $sql = "SELECT categories_id, categories_name, categories_active, categories_status FROM medicine_categories WHERE categories_status = 1 AND categories_active = 1";
                                $result = $connect->query($sql);
