...
if (isset($_POST['submit'])) {
    ...
    try {
        ...
        header("Location: doc_billing.php?patient_id=$patientId&success=History, drug, patient history, and dosage updated successfully!");
        exit();
    } catch (PDOException $e) {
        header("Location: prescribe.php?patient_id=$patientId&error=Failed to update data: " . $e->getMessage());
        exit();
    }
}
?>
